...
enum opt_code
{
  ...
  OPT_mcpu_ = 1197,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1198,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1199,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1200,             /* -mgeneral-regs-only */
  OPT_mglibc = 1201,                         /* -mglibc */
  OPT_mlittle_endian = 1202,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1203,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1204,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1205,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1206,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1207,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1208,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1209,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1210,          /* -msign-return-address= */
  OPT_mstrict_align = 1211,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1212,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1213,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1214,                     /* -mtls-size= */
  OPT_mtune_ = 1215,                         /* -mtune= */
  OPT_muclibc = 1216,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1217,             /* -mverbose-cost-dump */
  OPT_n = 1218,                              /* -n */
  OPT_no_canonical_prefixes = 1219,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1220,              /* -no-integrated-cpp */
  OPT_no_pie = 1221,                         /* -no-pie */
  OPT_nocpp = 1222,                          /* -nocpp */
  OPT_nodefaultlibs = 1223,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1224,                   /* -nostartfiles */
  OPT_nostdinc = 1225,                       /* -nostdinc */
  OPT_nostdinc__ = 1226,                     /* -nostdinc++ */
  OPT_nostdlib = 1227,                       /* -nostdlib */
  OPT_o = 1228,                              /* -o */
  OPT_p = 1229,                              /* -p */
